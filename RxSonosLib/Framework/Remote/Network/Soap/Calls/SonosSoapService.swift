...
enum SonosSoapService {
    case group, transport, contentDirectory
//    case alarm, groupRenderingControl, connectionManager, queue, music, renderingControl, deviceProperties, systemProperties, musicProvider
